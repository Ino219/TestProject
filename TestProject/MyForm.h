...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(294, 28);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(294, 84);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(75, 23);
			this->button3->TabIndex = 4;
			this->button3->Text = L"参照";
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e);
			 private:System::Void openFileDialog(int index);
	private: String^ getDeleteExtension(String^ str);
	private: String^ getDeleteTail(String^ str);
